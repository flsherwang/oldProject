...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
        ...
        /**
         * Set the Dialog detial from String
         *
         * @param detial
         * @return
         */
        public Builder setDetial(String detial) {
            this.detial = detial;
            return this;
        }
        ...
        public CustomDialog create() {
            ...
            lp.width = OldApplication.screenW * 3 / 4;
            ...
            // set the neutral_btnText button
            if (neutral_btnText != null) {
                ((Button) layout.findViewById(R.id.neutral_btn)).setText(neutral_btnText);
                if (neutral_btnClickListener != null) {
                    ((Button) layout.findViewById(R.id.neutral_btn)).setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            neutral_btnClickListener.onClick(dialog, DialogInterface.BUTTON_NEGATIVE);
                        }
                    });
                } else {
                    ((Button) layout.findViewById(R.id.neutral_btn)).setOnClickListener(new View.OnClickListener() {
            ...
            // set the content detial
            if (detial != null) {
                ((TextView) layout.findViewById(R.id.detial)).setVisibility(View.VISIBLE);
                ((TextView) layout.findViewById(R.id.detial)).setText(detial);
            } else if (contentView != null) {
                // if no detial set
                // add the contentView to the dialog body
                // ((LinearLayout)
                // layout.findViewById(R.id.detial)).removeAllViews();
                // ((LinearLayout)
                // layout.findViewById(R.id.detial)).addView(contentView, new
                // LayoutParams(LayoutParams.WRAP_CONTENT,
                // LayoutParams.WRAP_CONTENT));
                ((TextView) layout.findViewById(R.id.detial)).setVisibility(View.GONE);
            }
