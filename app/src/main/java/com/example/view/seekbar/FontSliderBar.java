package com.example.view.seekbar;
...
public class FontSliderBar extends View {
    ...
    public FontSliderBar setCurrentIndex(int currentIndex) {
//        if (indexOutOfRange(currentIndex)) {
//            throw new IllegalArgumentException(
//                    "A thumb index is out of bounds. Check that it is between 0 and mTickCount - 1");
//        } else {
...
//                mCurrentIndex = currentIndex;
                if (mListener != null) {
                    mListener.onIndexChanged(this, currentIndex);
//                }
////            }
        }
        return FontSliderBar.this;
    ...
    private void createBar() {
        mBar = new Bar(getXCoordinate(), getYCoordinate(), getBarLength(), mTickCount, mTickHeight, mBarWidth, mBarColor, mTextColor, mTextSize, mTextPadding);
    }
