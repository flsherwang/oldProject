...
import static com.example.view.refresh.ILoadingLayout.State;
...
public class   PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
	 ...
	 * @param showFooter  是否显示底部view;
	 */
	public void setHasMoreData(boolean hasMoreData,boolean showFooter) {
		setHasMoreData(hasMoreData);
		LoadingLayout footerLoadingLayout = getFooterLoadingLayout();
		if(footerLoadingLayout!=null&&!showFooter){
	...
	public void footerRefreshSetting() {
