...
import com.example.util.ImageDisplayer;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item.isSelected) {
            ...
            mHolder.selectedIv.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.tag_no_selected));
            mHolder.selectedIv.setVisibility(View.VISIBLE);
            mHolder.selectedBgTv.setBackgroundResource(R.color.gray_bg);
        }
